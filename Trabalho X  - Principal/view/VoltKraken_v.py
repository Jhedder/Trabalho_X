...
def create_gradient_background(canvas, width, height):
    ...
    color1 = '#ADD8E6'  # Tomato
    color2 = '#ADD8E6'  # DarkRed
...
root = tk.Tk()
root.title("Volt Kraken - Mega Man X5")
...
image_path = "C:/Users/182400232/Documents/Trabalho/Trabalho X  - Principal/midia/imagens/Volt Kraken.jpg"  # Coloque o caminho da sua imagem aqui
...
info_text = """
Volt Kraken (ボルト・クラーケンBoruto Kurāken ) , também conhecido
como Squid Adler , [3] era um Maverick Hunter aposentado baseado em
lula gigante / kraken antes de ser infectado pelo vírus Sigma e
transformado em um Maverick durante os eventos de Mega Man X5 . Ele
segurava um carrinho de energia necessário para o canhão laser Enigma.
"""

# Criar um label para exibir o texto
text_label = tk.Label(root, text=info_text, justify=tk.LEFT, padx=10, pady=10, bg='#ADD8E6', fg='white',
