...
def create_gradient_background(canvas, width, height):
    ...
    color1 = '#FFFFFF'  # Tomato
    color2 = '#FFFFFF'  # DarkRed
...
root = tk.Tk()
root.title("Spiral Pegasus - Mega Man X5")
...
image_path = "C:/Users/182400232/Documents/Trabalho/Trabalho X  - Principal/midia/imagens/Spiral Pegasus.jpg"  # Coloque o caminho da sua imagem aqui
...
info_text = """
Spiral Pegasus , [2] conhecido como Spiral Pegacion [2] (スパイラル・ペ
ガシオンSupairaru Pegashion ) no Japão, também conhecido como The
Skiver , [3] é um Reploid temático de Pégaso de Mega Man X5 . Ele
possuía uma Asa Orbital necessária para a Operação do Ônibus Espacial
para destruir a colônia da Eurásia .
"""

# Criar um label para exibir o texto
text_label = tk.Label(root, text=info_text, justify=tk.LEFT, padx=10, pady=10, bg='#000000', fg='white',
