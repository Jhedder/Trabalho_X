...
root = tk.Tk()
root.title("Spike Rosered - Mega Man X5")
...
image_path = "C:/Users/182400232/Documents/Trabalho/Trabalho X  - Principal/midia/imagens/Spike RoseRed.jpg"  # Coloque o caminho da sua imagem aqui
original_image = Image.open(image_path)
resized_image = original_image.resize((400, 400))
photo = ImageTk.PhotoImage(resized_image)

# Criar um label para exibir a imagem
image_label = tk.Label(root, image=photo, bg='#8B0000')  
image_label.place(x=100, y=100)  # Posição relativa ao canvas

# Texto com informações sobre o Magma Dragoon
info_text = """
Spike Rosered (スパイク・ローズレッドSupaiku Rōzureddo ) , também
conhecido como Axle the Red , [2] é um Reploid baseado em rosas do
Mega Man X5 . Ele possuía o Orbiter Engine, que era uma parte
necessária para os reparos do Ônibus Espacial .
"""

# Criar um label para exibir o texto
text_label = tk.Label(root, text=info_text, justify=tk.LEFT, padx=10, pady=10, bg='#006400', fg='white',
font=('Helvetica', 12))  
