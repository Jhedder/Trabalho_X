...
root = tk.Tk()
root.title("Crescent Grizzly - Mega Man X5")
...
image_path = "C:/Users/182400232/Documents/Trabalho/Trabalho X  - Principal/midia/imagens/Crescent Grizzly.jpg"  # Coloque o caminho da sua imagem aqui
...
info_text = """
Crescent Grizzly (クレッセント・グリズリーKuressento Gurizurī ) ,
também conhecido como Grizzly Slash , [3] é um Reploid baseado em
urso pardo de Mega Man X5 . Ele é um corretor de armas que vende
armas ilegais de seu armazém secreto no norte da Sibéria, Rússia, e por
acaso tinha uma Bola de Cristal em sua posse, uma parte necessária
para o canhão laser Enigma .
"""

# Criar um label para exibir o texto
text_label = tk.Label(root, text=info_text, justify=tk.LEFT, padx=10, pady=10, bg='#8B0000', fg='white',
