...
root = tk.Tk()
root.title("Shining Firefly - Mega Man X5")
...
image_path = "C:/Users/182400232/Documents/Trabalho/Trabalho X  - Principal/midia/imagens/Shining Firefly.jpg"  # Coloque o caminho da sua imagem aqui
...
info_text = """
Shining Firefly , conhecido como Shining Hotarunicus [3] (シャイニン
グ・ホタルニクスShainingu Hotarunikusu ) no Japão, também
conhecido como Izzy Glow [4] é um personagem do jogo Mega Man X5.
Shining Firefly era um Reploid baseado em vaga-lume que estava de
posse do Dispositivo Laser necessário para consertar o canhão Enigma.
"""
