...
def create_gradient_background(canvas, width, height):
    ...
    color1 = '#00008B'  # Tomato
    color2 = '#00008B'  # DarkRed
...
root = tk.Tk()
root.title("Tidal Whale - Mega Man X5")
...
image_path = "C:/Users/182400232/Documents/Trabalho/Trabalho X  - Principal/midia/imagens/Tidal Whale.jpg"  # Coloque o caminho da sua imagem aqui
...
info_text = """
Tidal Whale , conhecida como Tidal Makkoeen (タイダル・マッコ
イーンTaidaru Makkoīn ) no Japão, também conhecido como Duff
McWhalen , [3] é um Reploid baseado em cachalote de Mega Man X5 . Ele
tinha alguma jurisdição sobre o Oceano Atlântico Norte, que os Maverick
Hunters precisavam para produzir hidrogênio para o canhão laser
Enigma .
"""

# Criar um label para exibir o texto
text_label = tk.Label(root, text=info_text, justify=tk.LEFT, padx=10, pady=10, bg='#00008B', fg='white',
